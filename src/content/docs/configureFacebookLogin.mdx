...
## PassportJS
Facebook interaction is handled with [PassportJS](https://www.passportjs.org/concepts/authentication/facebook/).

export const metadata = {
  title: 'Configure Facebook Login',
  fileName:'configure-facebook-login',
  imageLink: '',
  authors: ["Graham Houser"],
  pubDate: '01-28-2022',
  desc: 'Steps to setup the Facebook Login flow.',
}
